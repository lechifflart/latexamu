...
\iftrue % Affidavit of Honour for english thesis (invert the \if for an English thesis)
    ...
    \begin{flushright}\includegraphics[width=60px,height=23px]{signaturePL.png} \ \includegraphics[width=46px,height=59px]{signature_pierre.png}\end{flushright} % signature
\fi
