...
Different types of luminescence : photo-, cathodo-, electro-, ... depending on how the electrons are excited.
...
\begin{equation}
	\frac{f_{c\kk} (1-f_{v\kk})}{f_{v\kk} (1-f_{c\kk}) - f_{c\kk}(1-f_{v\kk})} = \frac{1}{e^{\omega - (\mu_e - \mu_h)/k_BT} - 1 }\approx e^{\omega - (\mu_e - \mu_h)/k_BT}
\end{equation}
...
\begin{align}
\begin{split}
	R^{sp}(\omega) &= \frac{n_1(\omega)^2\omega^2}{\pi^2 c^2}\ \alpha(\omega)\ e^{\omega - (\mu_e - \mu_h)/k_BT} \\
	 &= \frac{n_1(\omega)\omega^3}{\pi^2 c^3}\ \varepsilon_2(\omega)\ e^{\omega - (\mu_e - \mu_h)/k_BT} \label{eq:vRS_PL}
\end{split}
\end{align}
...
Now I need to talk about the Boltzmann distribution for excitons and we are good to go for this part.
