...
The polarizability in the \gls{RPA} writes : is it even RPA or is it just independent particles ?
\begin{equation}
	\chi^{RPA}_{00}
\end{equation}
...
% show the importance of excitonic effects, maybe ?
