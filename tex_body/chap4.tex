...
\begin{figure}[h!t]%
	...
	\label{fig:Gkkp_plot_hBN} %MODIF add label for colorbar
\end{figure}
...
\begin{figure}[h!bt]
	...
	\label{fig:mBN_Gkkp} %MODIF : trim + add label; add label for colorbar
\end{figure}
...
\begin{figure}[h!t]%
    ...
    \subfloat[Exciton dispersion of hBN]{\includegraphics[width=0.48\textwidth]{hBN_excdisp.pdf}}
    \caption{Phonon (left) and exciton (right) dispersions of bulk \acrshort{hBN}.}
    \label{fig:ph_exc_disp_hBN} %MODIF : trim and same size for both ; ticklabel is wrong it is H instead of L
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:bBN_excdisp} % MODIF ticklabel is wrong it is H instead of L
\end{figure}
...
\begin{figure}[h!b]%
	...
	\label{fig:Gkkp_plot_bBN} %MODIF add label for colorbar
\end{figure}
