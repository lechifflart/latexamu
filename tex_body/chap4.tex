...
\begin{figure}[h!b]%
	...
	\setcapindent{2em}
	\centering
    \subfloat[Comparison of finite-difference and \textit{ab initio} methods.]{\includegraphics[width=0.45\textwidth]{comparison_pl.pdf}} \label{comparison_fdd} \qquad 
