...
\end{multline}
This is the general expression which was implemented in the \yambo~code. With this expression, we see that using the exciton basis shifts the picture from electrons and holes scattering with phonons to transitions between excitonic states mediated by phonons.
...
%
%
construct a self-energy for the exciton-exciton interaction mediated by phonons.
